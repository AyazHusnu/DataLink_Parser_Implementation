...
public final class HelloServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.frontend.protocomp.HelloService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.frontend.protocomp.HelloRequest,
      com.frontend.protocomp.HelloResponse> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "hello",
      requestType = com.frontend.protocomp.HelloRequest.class,
      responseType = com.frontend.protocomp.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.frontend.protocomp.HelloRequest,
      com.frontend.protocomp.HelloResponse> getHelloMethod() {
    io.grpc.MethodDescriptor<com.frontend.protocomp.HelloRequest, com.frontend.protocomp.HelloResponse> getHelloMethod;
    if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
          HelloServiceGrpc.getHelloMethod = getHelloMethod =
              io.grpc.MethodDescriptor.<com.frontend.protocomp.HelloRequest, com.frontend.protocomp.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "hello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.frontend.protocomp.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.frontend.protocomp.HelloResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void hello(com.frontend.protocomp.HelloRequest request,
        io.grpc.stub.StreamObserver<com.frontend.protocomp.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceStub
    ...
    /**
     */
    public void hello(com.frontend.protocomp.HelloRequest request,
        io.grpc.stub.StreamObserver<com.frontend.protocomp.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceBlockingStub
    ...
    /**
     */
    public com.frontend.protocomp.HelloResponse hello(com.frontend.protocomp.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.frontend.protocomp.HelloResponse> hello(
        com.frontend.protocomp.HelloRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((com.frontend.protocomp.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.frontend.protocomp.HelloResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.frontend.protocomp.HelloRequest,
              com.frontend.protocomp.HelloResponse>(
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.frontend.protocomp.HelloServiceOuterClass.getDescriptor();
    }
